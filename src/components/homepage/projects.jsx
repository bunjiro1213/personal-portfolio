...
import fifaRating from "../../images/fc26-banner.jpg"
    ...
    <div id="projects" className={styles.projectSection}>
      ...
      <div className={styles.cardsRow}>
        <div className={styles.card}>
          <h2 className={styles.cardTitle}>FIFA Player Rating Prediction</h2>
          <p className={styles.projectDescription}>
            Built a player-rating prediction pipeline using engineered FIFA features,
            nested cross-validation, XGBoost, and a Power BI dashboard for model insights.
          </p>
          <div className={styles.imageWrapper}>
            <img src={fifaRating} alt="FC 26 banner" className={styles.projectImage} />
          </div>
          <div className={styles.footerRow}>
            <div className={styles.tags}>
              <span className={styles.tag}>Python</span>
              <span className={styles.tag}>Power BI</span>
              <span className={styles.tag}>XGBoost</span>
            </div>
            <button
              className={styles.expandButton}
              aria-label="Open FIFA Player Rating Prediction on GitHub"
              onClick={() => window.open("https://github.com/bunjiro1213/fifa-rating-analysis", "_blank")}
            >
              Open in GitHub
            </button>
          </div>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.footerRow}>
            ...
            <button
              className={styles.expandButton}
              aria-label="Open Jacob Oestreicher Coaching Web App on GitHub"
        ...
        <div className={styles.card}>
          ...
          <div className={styles.footerRow}>
            ...
            <button
              className={styles.expandButton}
              aria-label="Open Home Prices Predictor on GitHub"
